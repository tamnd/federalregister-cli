...
```
fedreg <command> [arguments] [flags]
```

Run `fedreg <command> --help` for the full flag list on any command. This
...
per operation you declare in `federalregister/domain.go`.
