...
Most of these come down to network reality or how federalregister serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

federalregister rate-limits like any public site. fedreg already paces
...
Where a surface is gated, fedreg reads a cookie or token you supply
...
`fedreg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what fedreg actually did
